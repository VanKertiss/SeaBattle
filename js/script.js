...
const game = {
    ...
    generateShip(){
        for(let i = 0; i < this.optionShip.count.length; i++){
            for(let j = 0; j < this.optionShip.count[i]; j++){
                const size = this.optionShip.count[j];
    ...
    generateOptionsShip(shipSize){
        ...
        if(direction){
            x = Math.floor(x = Math.random() * 10);
            y = Math.floor(y = Math.random() * (10 - shipSize));
        }else{
            x = Math.floor(x = Math.random() * (10 - shipSize));
            y = Math.floor(y = Math.random() * 10);
        }
